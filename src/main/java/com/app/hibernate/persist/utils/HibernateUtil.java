...
public class HibernateUtil {
    ...
    private static void getWhere(StringBuilder builder, Map<String, Object> params) {
        if (MapUtils.isNotEmpty(params)) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (i == list.size() - 1) {
                    setByMap(builder, list.get(i));
                } else {
                    setAndByMap(builder, list.get(i));
                }
            }
        }
    }
     ...
     * @version 1.0
     */
    private static void setByMap(StringBuilder builder, String property) {
        builder.append(" = ");
        builder.append(" :");
     ...
     * @version 1.0
     */
    private static void setAndByMap(StringBuilder builder, String property) {
        builder.append(" = ");
        builder.append(" :");
        builder.append(property);
        builder.append(" and ");
